    ...
    <>
      ...
      <aside id="left-sidebar" className="left-sidebar open" aria-hidden="false">
        ...
        <nav className="left-sidebar-nav" role="navigation" aria-label="Main menu">
          <button className="left-nav-item chat-tab" style={{ fontFamily: 'Poppins', fontWeight: 600, fontSize: 16 }} onClick={() => { if (window.navigateTo) return window.navigateTo('/chat'); if (window.showSection) window.showSection('chat'); if (window.closeLeftSidebar) window.closeLeftSidebar();  }}>Chat with Jaymantrix AI</button>
          ...
          <button className="left-nav-item" data-section="YT-videos" style={{ fontFamily: 'Poppins', fontWeight: 600, fontSize: 16 }} onClick={() => { if (window.navigateTo) return window.navigateTo('/YT-videos'); window.showSection && window.showSection('YT-videos'); if (window.closeLeftSidebar) window.closeLeftSidebar();  }}>YouTube Videos</button>
        ...
        <div className="sidebar-social-links"></div>
      </aside>
      ...
      <div className="content-wrapper" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <section id="yt-vid-section" className="yt-vid-section" style={{ display: 'none', paddingTop: 24 }}>
          <div id="yt-loading" className="yt-loading" style={{ display: 'none', textAlign: 'center', padding: 28 }}>Loading my YT Channel and Videos. Pls wait...</div>
