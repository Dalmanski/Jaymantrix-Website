...
window.showMyWebSection = async function() {
  let section = document.getElementById('my-web-section')
  if (!section) {
    section = document.createElement('section')
    section.id = 'my-web-section'
    document.querySelector('.content-wrapper').appendChild(section)
  }
  Array.from(document.querySelectorAll('main, #notes-section, #gm-rec-section, #chat-section')).forEach(e => { if (e) e.style.display = 'none' })
